    ...
    <div className="h-full snap-center" id="about">
      <div className="max-w-full max-h-full md:mt-20 mt-12 ">
        <div className="w-[80%] m-auto md:max-w-[1600px]">
          ...
          <div
            data-aos="fade-right"
            className="btm-nav z-10 rounded-full shadow-2xl bg-gray-200 flex btm-nav-lg h-[50px] dark:bg-[#D4AF37] w-[50px] md:left-[93%] md:top-[85%] sm:left-[90%] sm:top-[85%] left-[83%] top-[85%] animate-bounce"
          >
